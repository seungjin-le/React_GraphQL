...
describe('gql', function () {
  it('parses queries', function () {
    chai.assert.equal(
      gql$1(
        templateObject_1 ||
          (templateObject_1 = tslib.__makeTemplateObject(
            ['{ testQuery }'],
            ['{ testQuery }']
          ))
      ).kind,
  ...
  it('parses queries with weird substitutions', function () {
    ...
    chai.assert.equal(
      gql$1(
        templateObject_2 ||
          (templateObject_2 = tslib.__makeTemplateObject(
            ['{ field(input: "', '") }'],
            ['{ field(input: "', '") }']
          )),
        obj.missing
    ...
    chai.assert.equal(
      gql$1(
        templateObject_3 ||
          (templateObject_3 = tslib.__makeTemplateObject(
            ['{ field(input: "', '") }'],
            ['{ field(input: "', '") }']
          )),
        null
    ...
    chai.assert.equal(
      gql$1(
        templateObject_4 ||
          (templateObject_4 = tslib.__makeTemplateObject(
            ['{ field(input: "', '") }'],
            ['{ field(input: "', '") }']
          )),
        0
  ...
  it('allows interpolation of documents generated by the webpack loader', function () {
    ...
    var document = gql$1(
      templateObject_5 ||
        (templateObject_5 = tslib.__makeTemplateObject(
          ['query { ...SomeFragmentName } ', ''],
          ['query { ...SomeFragmentName } ', '']
        )),
      module.exports
    );
    ...
    var parsed = gql$1(
      templateObject_6 ||
        (templateObject_6 = tslib.__makeTemplateObject(
          ['fragment A ($arg: String!) on Type { testQuery }'],
          ['fragment A ($arg: String!) on Type { testQuery }']
        ))
    );
  ...
  it('correctly imports other files through the webpack loader', function () {
    var query =
      '#import "./fragment_definition.graphql"\n      query {\n        author {\n          ...authorDetails\n        }\n      }';
    ...
    var require = function (path) {
      ...
      return gql$1(
        templateObject_7 ||
          (templateObject_7 = tslib.__makeTemplateObject(
            [
  ...
  it('tracks fragment dependencies across fragments loaded via the webpack loader', function () {
    ...
    var require = function (path) {
      ...
      return gql$1(
        templateObject_8 ||
          (templateObject_8 = tslib.__makeTemplateObject(
            [
              '\n        fragment F222 on F {\n          f1\n          f2\n        }',
            ],
            [
  ...
  it('returns the same object for the same query', function () {
    chai.assert.isTrue(
      gql$1(
        templateObject_9 ||
          (templateObject_9 = tslib.__makeTemplateObject(
            ['{ sameQuery }'],
            ['{ sameQuery }']
          ))
      ) ===
        gql$1(
          templateObject_10 ||
            (templateObject_10 = tslib.__makeTemplateObject(
              ['{ sameQuery }'],
              ['{ sameQuery }']
            ))
        )
  ...
  it('returns the same object for the same query, even with whitespace differences', function () {
    chai.assert.isTrue(
      gql$1(
        templateObject_11 ||
          (templateObject_11 = tslib.__makeTemplateObject(
            ['{ sameQuery }'],
            ['{ sameQuery }']
          ))
      ) ===
  ...
  var fragmentAst = gql$1(
    templateObject_13 ||
      (templateObject_13 = tslib.__makeTemplateObject(
        [
  ...
  it('returns the same object for the same fragment', function () {
    chai.assert.isTrue(
      gql$1(
        templateObject_14 ||
          (templateObject_14 = tslib.__makeTemplateObject(
            ['fragment same on Same { sameQuery }'],
            ['fragment same on Same { sameQuery }']
          ))
      ) ===
        gql$1(
          templateObject_15 ||
            (templateObject_15 = tslib.__makeTemplateObject(
              ['fragment same on Same { sameQuery }'],
              ['fragment same on Same { sameQuery }']
            ))
        )
  ...
  it('returns the same object for the same document with substitution', function () {
    chai.assert.isTrue(
      gql$1(
        templateObject_16 ||
          (templateObject_16 = tslib.__makeTemplateObject(
            ['{ ...UserFragment } ', ''],
            ['{ ...UserFragment } ', '']
          )),
        fragmentAst
        ...
        gql$1(
          templateObject_17 ||
            (templateObject_17 = tslib.__makeTemplateObject(
              ['{ ...UserFragment } ', ''],
              ['{ ...UserFragment } ', '']
            )),
          fragmentAst
  ...
  it('can reference a fragment that references as fragment', function () {
    var secondFragmentAst = gql$1(
      templateObject_18 ||
        (templateObject_18 = tslib.__makeTemplateObject(
          [
    ...
    var ast = gql$1(
      templateObject_19 ||
        (templateObject_19 = tslib.__makeTemplateObject(
          [
            '\n      {\n        user(id: 5) {\n          ...SecondUserFragment\n        }\n      }\n      ',
            '\n    ',
          ],
    ...
    chai.assert.deepEqual(
      ...
      gql$1(
        templateObject_20 ||
          (templateObject_20 = tslib.__makeTemplateObject(
            [
              '\n      {\n        user(id: 5) {\n          ...SecondUserFragment\n        }\n      }\n      fragment SecondUserFragment on User {\n        ...UserFragment\n      }\n      fragment UserFragment on User {\n        firstName\n        lastName\n      }\n    ',
            ],
            [
  ...
  describe('fragment warnings', function () {
    ...
    it('warns if you use the same fragment name for different fragments', function () {
      var frag1 = gql$1(
        templateObject_21 ||
          (templateObject_21 = tslib.__makeTemplateObject(
            ['fragment TestSame on Bar { fieldOne }'],
            ['fragment TestSame on Bar { fieldOne }']
          ))
      );
      var frag2 = gql$1(
        templateObject_22 ||
          (templateObject_22 = tslib.__makeTemplateObject(
            ['fragment TestSame on Bar { fieldTwo }'],
            ['fragment TestSame on Bar { fieldTwo }']
          ))
      );
    ...
    it('does not warn if you use the same fragment name for the same fragment', function () {
      var frag1 = gql$1(
        templateObject_23 ||
          (templateObject_23 = tslib.__makeTemplateObject(
            ['fragment TestDifferent on Bar { fieldOne }'],
            ['fragment TestDifferent on Bar { fieldOne }']
          ))
      );
      var frag2 = gql$1(
        templateObject_24 ||
          (templateObject_24 = tslib.__makeTemplateObject(
            ['fragment TestDifferent on Bar { fieldOne }'],
            ['fragment TestDifferent on Bar { fieldOne }']
          ))
      );
    ...
    it('does not warn if you use the same embedded fragment in two different queries', function () {
      var frag1 = gql$1(
        templateObject_25 ||
          (templateObject_25 = tslib.__makeTemplateObject(
            ['fragment TestEmbedded on Bar { field }'],
            ['fragment TestEmbedded on Bar { field }']
          ))
      );
      var query1 = gql$1(
        templateObject_26 ||
          (templateObject_26 = tslib.__makeTemplateObject(
            ['{ bar { fieldOne ...TestEmbedded } } ', ''],
            ['{ bar { fieldOne ...TestEmbedded } } ', '']
          )),
        frag1
      );
      var query2 = gql$1(
        templateObject_27 ||
          (templateObject_27 = tslib.__makeTemplateObject(
            ['{ bar { fieldTwo ...TestEmbedded } } ', ''],
            ['{ bar { fieldTwo ...TestEmbedded } } ', '']
          )),
        frag1
      );
    ...
    it('does not warn if you use the same fragment name for embedded and non-embedded fragments', function () {
      var frag1 = gql$1(
        templateObject_28 ||
          (templateObject_28 = tslib.__makeTemplateObject(
            ['fragment TestEmbeddedTwo on Bar { field }'],
            ['fragment TestEmbeddedTwo on Bar { field }']
          ))
      );
      gql$1(
        templateObject_29 ||
          (templateObject_29 = tslib.__makeTemplateObject(
            ['{ bar { ...TestEmbedded } } ', ''],
            ['{ bar { ...TestEmbedded } } ', '']
          )),
        frag1
      ...
      gql$1(
        templateObject_30 ||
          (templateObject_30 = tslib.__makeTemplateObject(
            [
              '{ bar { ...TestEmbedded } } fragment TestEmbeddedTwo on Bar { field }',
            ],
            [
              '{ bar { ...TestEmbedded } } fragment TestEmbeddedTwo on Bar { field }',
            ]
  ...
  describe('unique fragments', function () {
    ...
    it('strips duplicate fragments from the document', function () {
      var frag1 = gql$1(
        templateObject_31 ||
          (templateObject_31 = tslib.__makeTemplateObject(
            ['fragment TestDuplicate on Bar { field }'],
            ['fragment TestDuplicate on Bar { field }']
          ))
      );
      var query1 = gql$1(
        templateObject_32 ||
          (templateObject_32 = tslib.__makeTemplateObject(
            ['{ bar { fieldOne ...TestDuplicate } } ', ' ', ''],
            ['{ bar { fieldOne ...TestDuplicate } } ', ' ', '']
          )),
        frag1,
        frag1
      ...
      var query2 = gql$1(
        templateObject_33 ||
          (templateObject_33 = tslib.__makeTemplateObject(
            ['{ bar { fieldOne ...TestDuplicate } } ', ''],
            ['{ bar { fieldOne ...TestDuplicate } } ', '']
          )),
        frag1
