...
exports.isDescribable =
  exports.transformCommentsToDescriptions =
  exports.parseGraphQLSDL =
    void 0;
...
function parseGraphQLSDL(location, rawSDL, options = {}) {
  ...
  try {
    if (options.commentDescriptions && rawSDL.includes('#')) {
      ...
      document = (0, graphql_1.parse)(
        new graphql_1.Source(rawSDL, location),
        options
      );
    }
  } catch (e) {
...
function isDescribable(node) {
  return (
    (0, graphql_1.isTypeSystemDefinitionNode)(node) ||
