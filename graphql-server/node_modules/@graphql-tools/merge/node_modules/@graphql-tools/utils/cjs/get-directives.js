...
exports.getDirective =
  exports.getDirectives =
  exports.getDirectiveInExtensions =
  exports.getDirectivesInExtensions =
    void 0;
...
function getDirectiveInExtensions(
  ...
  return _getDirectiveInExtensions(
      ...
      for (const directiveNode of astNode.directives) {
        ...
        if (schemaDirective) {
          result.push({
            ...
            args: (0, getArgumentValues_js_1.getArgumentValues)(
              schemaDirective,
              directiveNode
            ),
          });
    ...
    if (astNode.directives) {
      for (const directiveNode of astNode.directives) {
        if (directiveNode.name.value === directiveName) {
          result.push(
            (0, getArgumentValues_js_1.getArgumentValues)(
              schemaDirective,
              directiveNode
            )
          );
