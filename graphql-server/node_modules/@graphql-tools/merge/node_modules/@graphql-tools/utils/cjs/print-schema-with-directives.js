...
exports.makeDirectiveNodes =
  exports.makeDirectiveNode =
  exports.makeDeprecatedDirective =
  exports.astFromEnumValue =
  exports.astFromInputField =
  exports.astFromField =
  exports.astFromScalarType =
  exports.astFromEnumType =
  exports.astFromInputObjectType =
  exports.astFromUnionType =
  exports.astFromInterfaceType =
  exports.astFromObjectType =
  exports.astFromArg =
  exports.getDeprecatableDirectiveNodes =
  exports.getDirectiveNodes =
  exports.astFromDirective =
  exports.astFromSchema =
  exports.printSchemaWithDirectives =
  exports.getDocumentNodeFromSchema =
    void 0;
...
function astFromDirective(directive, schema, pathToDirectivesInExtensions) {
  ...
  return {
    ...
    arguments:
      (_c = directive.args) === null || _c === void 0
        ? void 0
        : _c.map((arg) =>
    ...
    locations:
      ((_d = directive.locations) === null || _d === void 0
        ? void 0
        : _d.map((location) => ({
            kind: graphql_1.Kind.NAME,
            value: location,
...
function getDirectiveNodes(entity, schema, pathToDirectivesInExtensions) {
  const directivesInExtensions = (0,
  get_directives_js_1.getDirectivesInExtensions)(
    entity,
    pathToDirectivesInExtensions
  );
  let nodes = [];
  ...
  return {
    ...
    defaultValue:
      arg.defaultValue !== undefined
        ? (_c = (0, graphql_1.astFromValue)(arg.defaultValue, arg.type)) !==
            null && _c !== void 0
          ? _c
          : undefined
        : undefined,
...
function astFromObjectType(type, schema, pathToDirectivesInExtensions) {
  ...
  return {
    ...
    interfaces: Object.values(type.getInterfaces()).map((iFace) =>
      (0, astFromType_js_1.astFromType)(iFace)
    ),
...
function astFromUnionType(type, schema, pathToDirectivesInExtensions) {
  ...
  return {
    ...
    types: type
      .getTypes()
      .map((type) => (0, astFromType_js_1.astFromType)(type)),
  };
}
...
function astFromScalarType(type, schema, pathToDirectivesInExtensions) {
  ...
  if (
    specifiedByValue &&
    !directives.some(
      (directiveNode) => directiveNode.name.value === 'specifiedBy'
    )
  ) {
  ...
  return {
    ...
    description:
      (_c =
        (_b = type.astNode) === null || _b === void 0
          ? void 0
...
function astFromInputField(field, schema, pathToDirectivesInExtensions) {
  ...
  return {
    ...
    defaultValue:
      (_c = (0, graphql_1.astFromValue)(field.defaultValue, field.type)) !==
        null && _c !== void 0
        ? _c
        : undefined,
  };
