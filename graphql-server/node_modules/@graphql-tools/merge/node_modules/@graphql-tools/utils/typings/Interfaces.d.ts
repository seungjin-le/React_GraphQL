...
export declare type ExecutionResult<TData = Record<string, any>> =
...
export declare type ObjectFieldFilter = (
  typeName: string,
  fieldName: string,
...
export declare type TypeSource =
  | string
  | Source
  | DocumentNode
  | GraphQLSchema
...
export declare type SchemaFieldMapperTypes = Array<
  | MapperKind.FIELD
