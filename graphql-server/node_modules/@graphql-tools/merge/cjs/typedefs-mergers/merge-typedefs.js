...
function mergeTypeDefs(typeSource, config) {
  ...
  let result;
  if (
    config === null || config === void 0 ? void 0 : config.commentDescriptions
  ) {
...
function visitTypeSources(
  ...
  if (typeSource && !visitedTypeSources.has(typeSource)) {
    ...
    if (typeof typeSource === 'function') {
      ...
      const documentNode = (0, utils_1.getDocumentNodeFromSchema)(
        typeSource,
        options
      );
      visitTypeSources(
      ...
      (0, utils_js_1.isStringTypes)(typeSource) ||
      (0, utils_js_1.isSourceTypes)(typeSource)
    ) {
      ...
      typeof typeSource === 'object' &&
      (0, graphql_1.isDefinitionNode)(typeSource)
    ) {
...
function mergeGraphQLTypes(typeSource, config) {
  ...
  if (
    ...
    for (const opTypeDefNodeType in schema_def_js_1.DEFAULT_OPERATION_TYPE_NAME_MAP) {
      ...
      if (!opTypeDefNode) {
        const possibleRootTypeName =
          schema_def_js_1.DEFAULT_OPERATION_TYPE_NAME_MAP[opTypeDefNodeType];
        const existingPossibleRootType = mergedNodes[possibleRootTypeName];
        if (
          existingPossibleRootType != null &&
          existingPossibleRootType.name != null
        ) {
          operationTypes.push({
  ...
  if (
    ...
    !((_c =
      (_b = mergedNodes[merge_nodes_js_1.schemaDefSymbol]) === null ||
      _b === void 0
        ? void 0
        : _b.operationTypes) === null || _c === void 0
      ? void 0
      : _c.length)
  ) {
  ...
  if (config === null || config === void 0 ? void 0 : config.sort) {
    const sortFn =
      typeof config.sort === 'function'
        ? config.sort
        : utils_js_1.defaultStringComparator;
