...
function addMocksToSchema({
  ...
  const mockResolver = (source, args, contex, info) => {
    const defaultResolvedValue = (0, graphql_1.defaultFieldResolver)(
      source,
      args,
      contex,
      info
    ...
    [utils_1.MapperKind.OBJECT_FIELD]: (fieldConfig) => {
      ...
      if (!preserveResolvers || !oldResolver) {
        ...
        newFieldConfig.resolve = async (rootObject, args, context, info) => {
          ...
          if (
            (0, utils_js_1.isObject)(mockedValue) &&
            (0, utils_js_1.isObject)(resolvedValue)
          ) {
            ...
            return (0, utils_js_1.copyOwnProps)(
              emptyObject,
              resolvedValue,
              mockedValue
            );
