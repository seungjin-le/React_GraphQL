...
const fast_json_stable_stringify_1 = tslib_1.__importDefault(
...
class MockStore {
  ...
  get(_typeName, _key, _fieldName, _fieldArgs) {
    if (typeof _typeName !== 'string') {
      if (_key === undefined) {
        if ((0, types_js_1.isRef)(_typeName)) {
          throw new Error(
            "Can't provide a ref as first argument and no other argument"
          );
        }
        // get({...})
    ...
    if (Array.isArray(_fieldName)) {
      ...
      return this.get(
        ref.$ref.typeName,
        ref.$ref.key,
        _fieldName.slice(1, _fieldName.length)
      );
    }
    // get('User', 'me', 'name'...);
  ...
  getImpl(args) {
    ...
    if (!fieldName) {
      if (
        ...
        !(0, types_js_1.isRecord)(defaultValue)
      ) {
    ...
    assertIsDefined(
      key,
      'key argument should be given when fieldName is given'
    );
  ...
  setImpl(args) {
    ...
    if (!fieldName) {
      if (!(0, types_js_1.isRecord)(value)) {
        throw new Error(
          'When no `fieldName` is provided, `value` should be a record.'
        );
      }
    ...
    try {
      ...
      throw new Error(
        `Value to set in ${typeName}.${fieldName} in not normalizable: ${e.message}`
      );
    }
    this.store[typeName][key] = {
      ...this.store[typeName][key],
  ...
  normalizeValueToStore(fieldType, value, currentValue, onInsertType) {
    ...
    if ((0, graphql_1.isCompositeType)(nullableFieldType)) {
      if (!(0, types_js_1.isRecord)(value))
        throw new Error(
          `should be an object or null or undefined. Received ${value}`
        );
      let joinedTypeName;
      ...
      return onInsertType(
        joinedTypeName,
        (0, types_js_1.isRef)(currentValue)
          ? { ...currentValue, ...value }
          : value
      );
    }
    if ((0, graphql_1.isListType)(nullableFieldType)) {
      if (!Array.isArray(value))
        throw new Error(
          `should be an array or null or undefined. Received ${value}`
        );
  ...
  generateValueFromType(fieldType) {
    ...
    if ((0, graphql_1.isScalarType)(nullableType)) {
      ...
      return [...new Array((0, utils_js_1.randomListLength)())].map(() =>
      ...
      let values = {};
      if (!mock) {
        typeName = (0, utils_js_1.takeRandom)(
      ...
      for (const fieldName in values) {
        ...
        toInsert[fieldName] =
          typeof fieldValue === 'function' ? fieldValue() : fieldValue;
      }
  ...
  getKeyFieldName(typeName) {
    var _a;
    const typePolicyKeyField =
      (_a = this.typePolicies[typeName]) === null || _a === void 0
        ? void 0
        : _a.keyFieldName;
