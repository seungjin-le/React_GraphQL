...
export interface IMockStore {
   ...
   */
  has<KeyT extends KeyTypeConstraints = string>(
    typeName: string,
    key: KeyT
  ): boolean;
  /**
...
export declare function isRef<KeyT extends KeyTypeConstraints = string>(
  maybeRef: unknown
): maybeRef is Ref<KeyT>;
export declare function assertIsRef<KeyT extends KeyTypeConstraints = string>(
  maybeRef: unknown,
  message?: string
