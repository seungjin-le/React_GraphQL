...
function visitResult(
  ...
  const operationDocumentNode = (0,
  getOperationASTFromRequest_js_1.getOperationASTFromRequest)(request);
...
function visitObjectValue(
  ...
  for (const [responseKey, subFieldNodes] of fieldNodeMap) {
    ...
    let fieldType =
      (_a = fieldMap[fieldName]) === null || _a === void 0 ? void 0 : _a.type;
    if (fieldType == null) {
      switch (fieldName) {
        case '__typename':
...
function visitFieldValue(
  ...
  if ((0, graphql_1.isListType)(nullableType)) {
    ...
    const collectedFields = (0, collectFields_js_1.collectSubFields)(
      schema,
      fragments,
      variableValues,
      finalType,
