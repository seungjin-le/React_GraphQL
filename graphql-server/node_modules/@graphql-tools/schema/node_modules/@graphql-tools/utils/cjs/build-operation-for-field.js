...
function resolveSelectionSet({
  ...
  if ((0, graphql_1.isInterfaceType)(type)) {
    const types = Object.values(schema.getTypeMap()).filter(
      (t) => (0, graphql_1.isObjectType)(t) && t.getInterfaces().includes(type)
    );
    return {
      kind: graphql_1.Kind.SELECTION_SET,
      selections: types
      ...
      selections: Object.keys(fields)
        .filter((fieldName) => {
          return !hasCircularRef(
            [...ancestors, (0, graphql_1.getNamedType)(fields[fieldName].type)],
            {
              depth: circularReferenceDepth,
            }
          );
...
function resolveField({
  ...
  if (
    !(0, graphql_1.isScalarType)(namedType) &&
    ...
    return {
      ...
      ...(fieldName !== field.name && {
        alias: { kind: graphql_1.Kind.NAME, value: fieldName },
      }),
      selectionSet:
        resolveSelectionSet({
          parent: type,
