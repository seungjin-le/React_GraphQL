...
function makeExecutableSchema({
  ...
  if ((0, graphql_1.isSchema)(typeDefs)) {
    ...
    parseOptions === null || parseOptions === void 0
      ? void 0
  ...
  if (Object.keys(resolverValidationOptions).length > 0) {
    (0, assertResolversPresent_js_1.assertResolversPresent)(
      schema,
      resolverValidationOptions
    );
  }
  if (schemaExtensions) {
    schemaExtensions = (0, merge_1.mergeExtensions)(
      (0, utils_1.asArray)(schemaExtensions)
    );
