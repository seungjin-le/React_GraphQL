...
export declare type GraphQLRequestListenerParsingDidEnd = (
  err?: Error
) => Promise<void>;
export declare type GraphQLRequestListenerValidationDidEnd = (
  err?: ReadonlyArray<Error>
) => Promise<void>;
export declare type GraphQLRequestListenerExecutionDidEnd = (
  err?: Error
) => Promise<void>;
export declare type GraphQLRequestListenerDidResolveField = (
  error: Error | null,
  result?: any
) => void;
