      ...
      function (t, i) {
        i.exports = function (t) {
          for (
            ...
            var s = r[e].resolve(),
              u = t.i.indexOf(s),
              o = s.resolvedType instanceof c ? 'int32' : s.type,
              f = a.basic[o];
    ...
    26: [
      function (t, i) {
        ...
        (n.fromJSON = function (t, i) {
          ...
          (n.prototype.resolvePath = y.path.resolve),
          (n.prototype.load = function t(i, s, e) {
            'function' == typeof s && ((e = s), (s = g));
            var u = this;
            if (!e) return y.asPromise(t, u, i, s);
            var o = e === b;
            function f(t, i) {
              if (e) {
                var n = e;
            ...
            function c(t, i) {
              try {
                if (
                  (y.isString(i) && '{' === i.charAt(0) && (i = JSON.parse(i)),
                  y.isString(i))
                ) {
                  v.filename = t;
                  var n,
            ...
            function a(n, r) {
              if (!(-1 < u.files.indexOf(n)))
                if ((u.files.push(n), n in d))
                  ...
                  var t;
                  try {
                    t = y.fs.readFileSync(n).toString('utf8');
                  } catch (t) {
                    return void (r || f(t));
                  }
                  c(n, t);
                  ...
                  ++l,
                    y.fetch(n, function (t, i) {
                      --l, e && (t ? (r ? l || f(null, u) : f(t)) : c(n, i));
                    });
            }
            var l = 0;
            y.isString(i) && (i = [i]);
          ...
          (n.prototype.loadSync = function (t, i) {
            if (!y.isNode) throw Error('not supported');
        ...
        Object.defineProperties(w.prototype, {
          ...
          (w.prototype.setup = function () {
            ...
            (this.encode = d(this)({ Writer: l, types: i, util: v })),
              (this.decode = y(this)({ Reader: s, types: i, util: v })),
        ...
        i.exports = function (t) {
          ...
          for (var e = 0; e < t.fieldsArray.length; ++e) {
            ...
            if (
              ...
              i('if(!util.isObject(%s))', u)('return%j', c(s, 'object'))(
                'var k=Object.keys(%s)',
                u
              ...
              s.useToArray() &&
                ...
                i('if(!Array.isArray(%s))', o)('return%j', c(s, 'array'))(
                  'for(var i=0;i<%s.length;++i){',
                  o
                ),
                s.preEncoded() &&
        ...
        function a(t, i, n, r) {
          if (i.resolvedType)
            if (i.resolvedType instanceof u) {
              t('switch(%s){', r)('default:')('return%j', c(i, 'enum value'));
              for (
            ...
            switch (i.type) {
              ...
              case 'fixed32':
              case 'sfixed32':
                t('if(!util.isInteger(%s))', r)('return%j', c(i, 'integer'));
                break;
              case 'int64':
              case 'uint64':
              case 'sint64':
              ...
              case 'sfixed64':
                t(
                  ...
                  r,
                  r
                )('return%j', c(i, 'integer|Long'));
                break;
              case 'float':
              case 'double':
                t('if(typeof %s!=="number")', r)('return%j', c(i, 'number'));
                break;
              case 'bool':
                t('if(typeof %s!=="boolean")', r)('return%j', c(i, 'boolean'));
                break;
              case 'string':
                t('if(!util.isString(%s))', r)('return%j', c(i, 'string'));
                break;
              case 'bytes':
                t(
      ...
      function (t, i) {
        ...
        (c.create = r.Buffer
          ...
          (c.prototype.int32 = function (t) {
            return t < 0 ? this.b(v, 10, e.fromNumber(t)) : this.uint32(t);
          }),
          ...
          (c.prototype.bool = function (t) {
            return this.b(a, 1, t ? 1 : 0);
          }),
          (c.prototype.sfixed32 = c.prototype.fixed32 =
            function (t) {
              return this.b(d, 4, t >>> 0);
            }),
          (c.prototype.sfixed64 = c.prototype.fixed64 =
            function (t) {
              var i = e.from(t);
              return this.b(d, 4, i.lo).b(d, 4, i.hi);
            }),
          (c.prototype.float = function (t) {
            return this.b(r.float.writeFloatLE, 4, t);
          }),
          (c.prototype.double = function (t) {
            return this.b(r.float.writeDoubleLE, 8, t);
          });
        ...
        (c.prototype.bytes = function (t) {
          var i = t.length >>> 0;
          if (!i) return this.b(a, 1, 0);
          if (r.isString(t)) {
            var n = c.alloc((i = s.length(t)));
            s.decode(t, n, 0), (t = n);
          }
          return this.uint32(i).b(y, i, t);
        }),
          (c.prototype.string = function (t) {
            var i = u.length(t);
            return i ? this.uint32(i).b(u.write, i, t) : this.b(a, 1, 0);
          }),
    ...
    39: [
      function (t, i) {
        ...
        (s.prototype.bytes = function (t) {
          ...
          var i = t.length >>> 0;
          return this.uint32(i), i && this.b(u, i, t), this;
        }),
          (s.prototype.string = function (t) {
            var i = e.byteLength(t);
            return this.uint32(i), i && this.b(o, i, t), this;
          });
      },
      { 35: 35, 38: 38 },
    ],
