 ...
 * compiled thu, 16 jun 2022 22:40:39 utc
    ...
    /* end of prelude */ {
          ...
          function genValuePartial_fromObject(
            ...
            if (field.resolvedType) {
              ...
              switch (field.type) {
                case 'double':
                case 'float':
                  gen('m%s=Number(%s)', prop, ref); // also catches "NaN", "Infinity"
                  break;
                case 'uint32':
                case 'fixed32':
                  gen('m%s=%s>>>0', prop, ref);
                  break;
                case 'int32':
                case 'sint32':
                case 'sfixed32':
                ...
                case 'sfixed64':
                  ...
                  break;
                case 'bytes':
                  gen('if(typeof %s==="string")', ref)(
                    'util.base64.decode(%s,m%s=util.newBuffer(util.base64.length(%s)),0)',
                    ref,
                    prop,
                    ref
                  )('else if(%s.length)', ref)('m%s=%s', prop, ref);
                  break;
                case 'string':
                  gen('m%s=String(%s)', prop, ref);
                  break;
                case 'bool':
                  gen('m%s=Boolean(%s)', prop, ref);
                  break;
                /* default: gen
                ("m%s=%s", prop, ref);
                break; */
          ...
          converter.fromObject = function fromObject(mtype) {
            ...
            for (var i = 0; i < fields.length; ++i) {
              ...
              if (field.map) {
                ...
                gen('if(!Array.isArray(%s))', arrayRef)(
                  'throw TypeError(%j)',
                  field.fullName + ': array expected'
                )('m%s=[]', prop)('for(var i=0;i<%s.length;++i){', arrayRef);
                genValuePartial_fromObject(
                  gen,
                  field,
                  /* not sorted */ i,
      ...
      13: [
        function (require, module, exports) {
          ...
          function genTypePartial(gen, field, fieldIndex, ref) {
            ...
            if (field.preEncoded()) {
              gen('if (%s instanceof Uint8Array) {', ref)('w.uint32(%i)', key)(
                'w.bytes(%s)',
                ref
              )('} else {');
            }
            ...
            for (var i = 0; i < fields.length; ++i) {
              ...
              if (field.map) {
                ...
                if (field.packed && types.packed[type] !== undefined) {
                  ...
                  gen('for(var i=0;i<%s.length;++i)', arrayRef);
                  if (wireType === undefined)
      ...
      33: [
        function (require, module, exports) {
          ...
          Object.defineProperty(util, 'decorateRoot', {
            get: function () {
              return (
                roots['decorated'] || (roots['decorated'] = new (require(26))())
              );
            },
          });
        },
      ...
      35: [
        function (require, module, exports) {
           ...
           */
          util.Long =
            typeof process === 'undefined' || process.env.ENABLE_LONG
