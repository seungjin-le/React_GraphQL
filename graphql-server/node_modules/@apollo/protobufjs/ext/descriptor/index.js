...
module.exports =
  ...
  $protobuf.descriptor =
    $protobuf.Root.fromJSON(
      require('../../google/protobuf/descriptor.json')
...
Root.fromDescriptor = function fromDescriptor(descriptor) {
  ...
  if (descriptor.file) {
    ...
    for (var j = 0, i; j < descriptor.file.length; ++j) {
      ...
      var opts = fromDescriptorOptions(
...
function Root_toDescriptorRecursive(ns, files, syntax) {
  ...
  var file = exports.FileDescriptorProto.create({
    name:
      ns.filename ||
      (ns.fullName.substring(1).replace(/\./g, '_') || 'root') + '.proto',
  });
...
Type.fromDescriptor = function fromDescriptor(descriptor, syntax) {
  ...
  /* Nested types */ if (descriptor.nestedType)
    for (i = 0; i < descriptor.nestedType.length; ++i) {
      ...
      if (
        descriptor.nestedType[i].options &&
        descriptor.nestedType[i].options.mapEntry
      )
  ...
  /* Extension ranges */ if (
    ...
    descriptor.extensionRange.length
  ) {
    type.extensions = [];
...
Type.prototype.toDescriptor = function toDescriptor(syntax) {
  ...
  /* Fields */ for (i = 0; i < this.fieldsArray.length; ++i) {
    ...
    descriptor.field.push(
      (fieldDescriptor = this._fieldsArray[i].toDescriptor(syntax))
    );
  ...
  descriptor.options = toDescriptorOptions(
    this.options,
...
Field.fromDescriptor = function fromDescriptor(descriptor, syntax) {
  ...
  field.options = fromDescriptorOptions(
    descriptor.options,
  ...
  if (descriptor.defaultValue && descriptor.defaultValue.length) {
    ...
    switch (defaultValue) {
      ...
      case 'FALSE':
        defaultValue = false;
        break;
      default: // eslint-disable-line radix
...
Field.prototype.toDescriptor = function toDescriptor(syntax) {
  ...
  descriptor.extendee = this.extensionField
  ...
  if (this.partOf)
    if (
      (descriptor.oneofIndex = this.parent.oneofsArray.indexOf(this.partOf)) < 0
    )
  ...
  if (syntax === 'proto3') {
    ...
    if (!this.packed)
      (
        descriptor.options ||
        (descriptor.options = exports.FieldOptions.create())
      ).packed = false;
  } else if (this.packed)
    // defaults to packed=false
    (
      descriptor.options || (descriptor.options = exports.FieldOptions.create())
    ).packed = true;
...
Enum.prototype.toDescriptor = function toDescriptor() {
  ...
  for (var i = 0, ks = Object.keys(this.values); i < ks.length; ++i)
    values.push(
      exports.EnumValueDescriptorProto.create({
        name: ks[i],
