...
function calculateReferencedFieldsByType({
  ...
  const documentSeparatedByOperation = (0, graphql_1.separateOperations)(
    document
  );
  const filteredDocument =
    documentSeparatedByOperation[
      resolvedOperationName !== null && resolvedOperationName !== void 0
        ? resolvedOperationName
        : ''
    ];
  if (!filteredDocument) {
    throw Error(
      `shouldn't happen: operation '${
        resolvedOperationName !== null && resolvedOperationName !== void 0
          ? resolvedOperationName
          : ''
      }' not found`
  ...
  for (const [typeName, fieldNames] of Object.entries(
    ...
    referencedFieldsByType[typeName] =
      new apollo_reporting_protobuf_1.ReferencedFieldsForType({
