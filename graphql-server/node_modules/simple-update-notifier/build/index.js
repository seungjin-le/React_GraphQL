...
var getLastUpdate = function (packageName) {
  ...
  try {
    ...
    var file = JSON.parse(
      fs__default['default'].readFileSync(configFile, 'utf8')
    );
...
var getDistVersion = function (packageName, distTag) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      url = 'https://registry.npmjs.org/-/package/'.concat(
        packageName,
        '/dist-tags'
      );
      return [
        ...
        case 0:
          if (
            ...
            (!process.stdout.isTTY ||
              (isNpmOrYarn && !args.shouldNotifyInNpmScript))
          ) {
            return [2 /*return*/];
          }
          _b.label = 1;
        ...
        case 2:
          ...
          if (latestVersion) {
            console.log(
              borderedText(
                'New version of '
                  .concat(args.pkg.name, ' available!\nCurrent Version: ')
                  .concat(args.pkg.version, '\nLatest Version: ')
