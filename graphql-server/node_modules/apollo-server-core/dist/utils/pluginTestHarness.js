...
async function pluginTestHarness({
  pluginInstance,
  schema,
  logger,
  graphqlRequest,
  ...
  if (typeof pluginInstance.serverWillStart === 'function') {
    ...
    if (
      maybeServerListener === null || maybeServerListener === void 0
        ? void 0
  ...
  if (!requestContext.document) {
    ...
    try {
      requestContext.document = (0, graphql_1.parse)(
    ...
    const validationErrors = (0, graphql_1.validate)(
  ...
  await dispatcher.invokeHook('willSendResponse', requestContext);
  await ((_b =
    serverListener === null || serverListener === void 0
      ? void 0
      : serverListener.serverWillStop) === null || _b === void 0
    ? void 0
    : _b.call(serverListener));
  return requestContext;
}
