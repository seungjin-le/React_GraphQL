...
exports.whenResultIsFinished =
  exports.pluginsEnabledForSchemaResolvers =
  exports.enablePluginsForSchemaResolvers =
  exports.symbolUserFieldResolver =
  exports.symbolExecutionDispatcherWillResolveField =
    void 0;
const type_1 = require('graphql/type');
const execution_1 = require('graphql/execution');
exports.symbolExecutionDispatcherWillResolveField = Symbol(
  ...
  field.resolve = (source, args, context, info) => {
    ...
    const willResolveField =
      context === null || context === void 0
        ? void 0
        : context[exports.symbolExecutionDispatcherWillResolveField];
    const userFieldResolver =
      context === null || context === void 0
        ? void 0
        : context[exports.symbolUserFieldResolver];
    ...
    const fieldResolver =
      ...
      userFieldResolver ||
      execution_1.defaultFieldResolver;
    try {
      let result;
      if (whenObjectResolved) {
...
function forEachField(schema, fn) {
  ...
  Object.entries(typeMap).forEach(([typeName, type]) => {
    if (
      !(0, type_1.getNamedType)(type).name.startsWith('__') &&
