...
exports.cloneObject =
  exports.processHTTPRequest =
  exports.runHttpQuery =
  exports.throwHttpGraphQLError =
  exports.isHttpQueryError =
  exports.HttpQueryError =
    void 0;
...
const NODE_ENV =
  (_a = process.env.NODE_ENV) !== null && _a !== void 0 ? _a : '';
...
async function runHttpQuery(
  ...
  let options;
  try {
    options = await (0, graphqlOptions_1.resolveGraphqlOptions)(
      request.options,
      ...handlerArguments
    );
  } catch (e) {
  ...
  try {
    if (Array.isArray(requestPayload)) {
      ...
      const responses = await Promise.all(
        requests.map(async (request) => {
          try {
            ...
            const response = await (0, requestPipeline_1.processGraphQLRequest)(
              options,
              requestContext
            );
            if (response.http) {
      ...
      if (response.errors && typeof response.data === 'undefined') {
        return throwHttpGraphQLError(
          ((_a = response.http) === null || _a === void 0
            ? void 0
            : _a.status) || 400,
          response.errors,
          undefined,
          response.extensions,
          (_b = response.http) === null || _b === void 0 ? void 0 : _b.headers
        );
      }
      if (response.http) {
        for (const [name, value] of response.http.headers) {
