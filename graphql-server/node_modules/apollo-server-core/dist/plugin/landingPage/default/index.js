...
exports.getEmbeddedSandboxHTML =
  exports.getEmbeddedExplorerHTML =
...
<script>
  ...
  new window.EmbeddedSandbox({
    ...
    initialEndpoint,
    includeCookies: ${
      (_a = config.includeCookies) !== null && _a !== void 0 ? _a : 'false'
    },
    initialState: ${getConfigStringForHtml({
      document:
        (_b = config.document) !== null && _b !== void 0 ? _b : undefined,
      variables:
        (_c = config.variables) !== null && _c !== void 0 ? _c : undefined,
...
function ApolloServerPluginLandingPageDefault(maybeVersion, config) {
  const version =
    maybeVersion !== null && maybeVersion !== void 0 ? maybeVersion : '_latest';
  return {
