...
exports.OurContextualizedStats =
  exports.OurReport =
  exports.SizeEstimator =
    void 0;
...
class OurReport {
  ...
  addTrace({
    ...
    if (asTrace) {
      const encodedTrace =
        apollo_reporting_protobuf_1.Trace.encode(trace).finish();
...
class OurContextualizedStats {
  ...
  addTrace(trace, sizeEstimator) {
    ...
    if (
      ...
      ((_a = trace.cachePolicy) === null || _a === void 0
        ? void 0
        : _a.maxAgeNs) != null
    ) {
