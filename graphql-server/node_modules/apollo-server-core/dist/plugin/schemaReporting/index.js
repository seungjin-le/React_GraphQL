...
exports.computeCoreSchemaHash = exports.ApolloServerPluginSchemaReporting =
  void 0;
  ...
  return {
    ...
    async serverWillStart({ apollo, schema, logger }) {
      ...
      if (overrideReportedSchema) {
        try {
          const validationErrors = (0, graphql_1.validateSchema)(
            (0, graphql_1.buildSchema)(overrideReportedSchema, {
              noLocation: true,
            })
          );
      ...
      return {
        schemaDidLoadOrUpdate({ apiSchema, coreSupergraphSdl }) {
          ...
          const coreSchema =
            (_a =
              overrideReportedSchema !== null &&
              overrideReportedSchema !== void 0
                ? overrideReportedSchema
                : coreSupergraphSdl) !== null && _a !== void 0
              ? _a
          ...
          currentSchemaReporter === null || currentSchemaReporter === void 0
            ? void 0
          ...
          currentSchemaReporter = new schemaReporter_1.SchemaReporter({
            ...
            initialReportingDelayInMs: Math.floor(
              Math.random() *
                (initialDelayMaxMs !== null && initialDelayMaxMs !== void 0
                  ? initialDelayMaxMs
                  : 10000)
            ),
