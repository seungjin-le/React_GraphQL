...
exports.ApolloServerPluginCacheControlDisabled =
...
function ApolloServerPluginCacheControl(options = Object.create(null)) {
  ...
  return {
    ...
    async requestDidStart(requestContext) {
      var _a, _b;
      const defaultMaxAge =
        (_a = options.defaultMaxAge) !== null && _a !== void 0 ? _a : 0;
      const calculateHttpHeaders =
        (_b = options.calculateHttpHeaders) !== null && _b !== void 0
          ? _b
          : true;
          ...
          return {
            willResolveField({ info }) {
              ...
              return () => {
                if (
                  fieldPolicy.maxAge === undefined &&
                  (((0, graphql_1.isCompositeType)(targetType) &&
                    !inheritMaxAge) ||
                    !info.path.prev)
                ) {
                ...
                if (__testing__cacheHints && isRestricted(fieldPolicy)) {
                  const path = (0, graphql_1.responsePathAsArray)(
                    info.path
                  ).join('.');
...
function cacheAnnotationFromDirectives(directives) {
  ...
  const scope =
    ((_a =
      scopeArgument === null || scopeArgument === void 0
        ? void 0
        : scopeArgument.value) === null || _a === void 0
      ? void 0
      : _a.kind) === 'EnumValue'
  ...
  if (
    ((_b =
      inheritMaxAgeArgument === null || inheritMaxAgeArgument === void 0
        ? void 0
        : inheritMaxAgeArgument.value) === null || _b === void 0
      ? void 0
      : _b.kind) === 'BooleanValue' &&
  ...
  return {
    maxAge:
      ((_c =
        maxAgeArgument === null || maxAgeArgument === void 0
          ? void 0
          : maxAgeArgument.value) === null || _c === void 0
        ? void 0
        : _c.kind) === 'IntValue'
