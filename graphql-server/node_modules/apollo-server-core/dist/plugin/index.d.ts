...
export declare function ApolloServerPluginUsageReporting<TContext>(
...
export declare function ApolloServerPluginSchemaReporting(
...
export declare function ApolloServerPluginInlineTrace(
...
export declare function ApolloServerPluginCacheControl(
...
export declare function ApolloServerPluginDrainHttpServer(
...
export declare function ApolloServerPluginLandingPageLocalDefault(
  options?: ApolloServerPluginLandingPageLocalDefaultOptions
): ApolloServerPlugin;
export declare function ApolloServerPluginLandingPageProductionDefault(
