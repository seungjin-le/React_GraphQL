...
exports.formatApolloErrors =
  exports.UserInputError =
  exports.PersistedQueryNotSupportedError =
  exports.PersistedQueryNotFoundError =
  exports.ForbiddenError =
  exports.AuthenticationError =
  exports.ValidationError =
  exports.SyntaxError =
  exports.fromGraphQLError =
  exports.toApolloError =
  exports.ApolloError =
    void 0;
...
function enrichError(error, debug = false) {
  ...
  expanded.extensions = {
    ...
    exception: {
      ...((_b = error.extensions) === null || _b === void 0
        ? void 0
        : _b.exception),
      ...error.originalError,
    },
  ...
  if (debug && !expanded.extensions.exception.stacktrace) {
    const stack =
      ((_c = error.originalError) === null || _c === void 0
        ? void 0
        : _c.stack) || error.stack;
...
function fromGraphQLError(error, options) {
  const copy = (
    options === null || options === void 0 ? void 0 : options.errorClass
  )
  ...
  if (!copy.extensions.code) {
    copy.extensions.code =
      (options === null || options === void 0 ? void 0 : options.code) ||
      'INTERNAL_SERVER_ERROR';
  }
    ...
    try {
      ...
      if (debug) {
        ...
        const newError = fromGraphQLError(
          new graphql_1.GraphQLError('Internal server error')
        );
